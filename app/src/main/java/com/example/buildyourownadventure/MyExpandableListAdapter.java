...
public class MyExpandableListAdapter extends BaseExpandableListAdapter{
    ...
    public MyExpandableListAdapter(Context context, List<String> parentList,
    ...
    public View getGroupView(int i, boolean b, View view, ViewGroup viewGroup) {
        String parentName = getGroup(i).toString();
        if(view == null){
            LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            view = inflater.inflate(R.layout.details_item, null);
        }
        TextView item = view.findViewById(R.id.detail_header);
    ...
    public View getChildView(int i, int i1, boolean b, View view, ViewGroup viewGroup) {
        ...
        TextView item = view.findViewById(R.id.details_child);
        item.setText(child);
        return view;
    }
